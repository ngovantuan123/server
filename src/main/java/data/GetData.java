...
public class GetData {
    public static void main(String[] args) throws InterruptedException {
        ...
        //DV:Điện tử viễn thông
        //GM:Giáo dục mầm non
        //GT:Giáo dục tiểu học
        //KT:Sư phạm kỹ thuật
        //LC:Giáo dục chính trị
        //LU:Luật
        //MI:Nghê thuật
        //MO:Khoa học môi trường
        //NN: Ngoại ngữ
        //NT:Nghệ thuật
        //QD:Quản trị kinh doanh
        //QG:Giáo Dục
        //QP:Quốc phong an ninh
        //TD:Toán Ưng Dụng
        //TE:Tài chính kế toán
        //TN:Sư phạm khoa học tự nhiên
        //TT:Thư viện văn phòng
        //VD:Quan hệ quốc tế
        //XH:Sư phạm khoa học xã hội
        ...
        String[] khoa ={"CT","DV","GM","GT","KT","LC","LU","MI","MO","NN","NT","QD","QG","QP","TD","TE","TN","TT","VD","XH"};
        for(int _khoa =0; _khoa<khoa.length;_khoa++){
            ...
            try {
                ...
                selectKhoa.selectByValue(khoa[_khoa]);
                Thread.sleep(3000);
